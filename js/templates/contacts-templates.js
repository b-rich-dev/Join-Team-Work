...
<div class="hide-on-desktop">
  ...
  <ul class="mobile-dropdown-menu">
    <li>
      <button class="mobile-dropdown-menu-button edit-button" data-id="${contact.id}" aria-label="Edit contact ${contact.name}">
      <svg viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-svg" aria-hidden="true" role="presentation">
        <path
    ...
    <li>
      <button class="mobile-dropdown-menu-button delete-button" data-id="${contact.id}" aria-label="Delete contact ${contact.name}">
      <svg viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-svg" aria-hidden="true" role="presentation">
        <path
